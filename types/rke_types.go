...
type AciNetworkProvider struct {
	...
	ServiceGraphEndpointAddServices   []AcidelayService `yaml:"service_graph_endpoint_add_services,omitempty" json:"serviceGraphEndpointAddServices,omitempty"`
}
