...
type RKESystemImages struct {
	...
	// Opflex Prometheus container image for Cisco ACI
	AciOpflexAgentPrometheus string `yaml:"aci_opflex_agent_prometheus" json:"aciOpflexAgentPrometheus,omitempty"`
	// Images with sha hash
	AciCniDeployContainerSha    string `yaml:"aci_cni_deploy_container_sha" json:"aciCniDeployContainerSha,omitempty"`
	AciHostContainerSha         string `yaml:"aci_host_container_Sha" json:"aciHostContainerSha,omitempty"`
	AciOpflexContainerSha       string `yaml:"aci_opflex_container_sha" json:"aciOpflexContainerSha,omitempty"`
	AciMcastContainerSha        string `yaml:"aci_mcast_container_sha" json:"aciMcastContainerSha,omitempty"`
	AciOpenvSwitchContainerSha  string `yaml:"aci_ovs_container_sha" json:"aciOvsContainerSha,omitempty"`
	AciControllerContainerSha   string `yaml:"aci_controller_container_sha" json:"aciControllerContainerSha,omitempty"`
	AciOpflexServerContainerSha string `yaml:"aci_opflex_server_container_sha" json:"aciOpflexServerContainerSha,omitempty"`
}
...
type AciNetworkProvider struct {
	...
	OpflexDeviceReconnectWaitTimeout     string              `yaml:"opflex-device-reconnect-wait-timeout,omitempty" json:"opflexDeviceReconnectWaitTimeout,omitempty"`
	OpflexAgentPrometheus                string              `yaml:"opflex-agent-prometheus,omitempty" json:"opflexAgentPrometheus,omitempty"`
	...
	AccProvisionOperatorMemoryRequest    string              `yaml:"acc_provision_operator_memory_limit,omitempty" json:"accProvisionOperatorMemoryRequest,omitempty"`
	AccProvisionOperatorMemoryLimit      string              `yaml:"acc_provision_operator_memory_request,omitempty" json:"accProvisionOperatorMemoryLimit,omitempty"`
	...
	UseDigest                            string              `yaml:"use_digest,omitempty" json:"UseDigest,omitempty"`
	CniDeployVersion                     string              `yaml:"cnideploy_version,omitempty" json:"cnideployVersion,omitempty"`
	AciContainersHostVersion             string              `yaml:"aci_containers_host_version,omitempty" json:"aciContainersHostVersion,omitempty"`
	OpflexAgentVersion                   string              `yaml:"opflex_agent_version,omitempty" json:"opflexAgentVersion,omitempty"`
	OpenvswitchVersion                   string              `yaml:"openvswitch_version,omitempty" json:"openvswitchVersion,omitempty"`
	AciContainersControllerVersion       string              `yaml:"aci_containers_controller_version,omitempty" json:"aciContainersControllerVersion,omitempty"`
	DpuEnable                            string              `yaml:"dpu_enable,omitempty" json:"dpuEnable,omitempty"`
	DpuOvsdbSocket                       string              `yaml:"dpu_ovsdb_socket,omitempty" json:"dpuOvsdbSocket,omitempty"`
	DpuIP                                string              `yaml:"dpu_ip,omitempty" json:"dpuIp,omitempty"`
	DpuUser                              string              `yaml:"dpu_user,omitempty" json:"dpuUser,omitempty"`
}
