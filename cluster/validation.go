...
func validateNetworkOptions(c *Cluster) error {
	...
	if c.Network.Plugin == AciNetworkPlugin {
		...
		cloudOptionsList := []string{AciEpRegistry, AciOpflexMode, AciUseHostNetnsVolume, AciApicSubscriptionDelay, AciApicRefreshtickerAdjust, AciOpflexDeviceDeleteTimeout, AciUseOpflexServerVolume,
