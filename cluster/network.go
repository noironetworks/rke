...
const (
	...
	AciUseDigest                            = "aci_use_digest"
	AciCniDeployVersion                     = "aci_cnideploy_version"
	AciAciContainersHostVersion             = "aci_aci_containers_host_version"
	AciOpflexAgentVersion                   = "aci_opflex_agent_version"
	AciOpenvswitchVersion                   = "aci_openvswitch_version"
	AciAciContainersControllerVersion       = "aci_aci_containers_controller_version"
	AciDpuEnable                            = "aci_dpu_enable"
	AciDpuOvsdbSocket                       = "aci_dpu_ovsdb_socket"
	AciOpflexAgentPrometheus                = "aci_opflex_agent_prometheus"
	AciDpuIP                                = "aci_dpu_ip"
	AciDpuUser                              = "aci_dpu_user"
	...
	AciCniDeployContainerSha               = "AciCniDeployContainerSha"
	AciHostContainerSha                    = "AciHostContainerSha"
	AciOpflexContainerSha                  = "AciOpflexContainerSha"
	AciMcastContainerSha                   = "AciMcastContainerSha"
	AciOpenvSwitchContainerSha             = "AciOpenvSwitchContainerSha"
	AciControllerContainerSha              = "AciControllerContainerSha"
	AciOpflexServerContainerSha            = "AciOpflexServerContainerSha"
	...
	UseDigest                              = "UseDigest"
	CniDeployVersion                       = "CniDeployVersion"
	AciContainersHostVersion               = "AciContainersHostVersion"
	OpflexAgentVersion                     = "OpflexAgentVersion"
	OpenvswitchVersion                     = "OpenvswitchVersion"
	AciContainersControllerVersion         = "AciContainersControllerVersion"
	DpuEnable                              = "DpuEnable"
	DpuOvsdbSocket                         = "DpuOvsdbSocket"
	OpflexAgentPrometheus                  = "OpflexAgentPrometheus"
	DpuIP                                  = "DpuIP"
	DpuUser                                = "DpuUser"
)
...
func (c *Cluster) doAciDeploy(ctx context.Context, data map[string]interface{}) error {
	...
	AciConfig := map[string]interface{}{
		...
		DpuEnable:                            c.Network.Options[AciDpuEnable],
		DpuOvsdbSocket:                       c.Network.Options[AciDpuOvsdbSocket],
		OpflexAgentPrometheus:                c.Network.Options[AciOpflexAgentPrometheus],
		DpuIP:                                c.Network.Options[AciDpuIP],
		DpuUser:                              c.Network.Options[AciDpuUser],
		UseDigest:                            c.Network.Options[AciUseDigest],
		CniDeployVersion:                     c.Network.Options[AciCniDeployVersion],
		AciContainersHostVersion:             c.Network.Options[AciAciContainersHostVersion],
		OpflexAgentVersion:                   c.Network.Options[AciOpflexAgentVersion],
		OpenvswitchVersion:                   c.Network.Options[AciOpenvswitchVersion],
		AciContainersControllerVersion:       c.Network.Options[AciAciContainersControllerVersion],
		...
		AciCniDeployContainerSha:             c.SystemImages.AciCniDeployContainerSha,
		AciHostContainerSha:                  c.SystemImages.AciHostContainerSha,
		AciOpflexContainerSha:                c.SystemImages.AciOpflexContainerSha,
		AciMcastContainerSha:                 c.SystemImages.AciMcastContainerSha,
		AciOpenvSwitchContainerSha:           c.SystemImages.AciOpenvSwitchContainerSha,
		AciControllerContainerSha:            c.SystemImages.AciControllerContainerSha,
		AciOpflexServerContainerSha:          c.SystemImages.AciOpflexServerContainerSha,
		MTU:                                  c.Network.MTU,
	}
