...
const (
	...
	AciGbpServerInitContainer              = "AciGbpServerInitContainer"
...
func (c *Cluster) doAciDeploy(ctx context.Context, data map[string]interface{}) error {
	...
	AciConfig := map[string]interface{}{
		...
		CsrList:                   c.Network.AciNetworkProvider.CsrList,
		...
		AciGbpServerInitContainer: c.SystemImages.AciGbpServerInitContainer,
